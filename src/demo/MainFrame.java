...
public class MainFrame extends JFrame {
    ...
    private final PersonSearch search = new PersonSearchImpl(persons, null);
    ...
    private void searchPerson(JTextField field) {//should change method to find multiple persons
        personTable.clearSelection();
        personTable.addColumnSelectionInterval(0, 1);
        searchPersonByName(field.getText().toLowerCase());
    }
